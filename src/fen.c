...
Bitboard* pieceBitboard(Board* board, int pieceType) {
    switch (pieceType) {
        case PAWN_W:   return &board->pawn_w;
        case KNIGHT_W: return &board->knight_w;
        case BISHOP_W: return &board->bishop_w;
        case ROOK_W:   return &board->rook_w;
        case QUEEN_W:  return &board->queen_w;
        case KING_W:   return &board->king_w;
        case PAWN_B:   return &board->pawn_b;
        case KNIGHT_B: return &board->knight_b;
        case BISHOP_B: return &board->bishop_b;
        case ROOK_B:   return &board->rook_b;
        case QUEEN_B:  return &board->queen_b;
        case KING_B:   return &board->king_b;
        default:       return NULL;
    }
}
